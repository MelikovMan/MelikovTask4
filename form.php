  ...
  <form action ="" method = "POST">
	...
	<label>
			...
			<select name="field-name-4[]" <?php if($errors['super']) print('class="error"');?>
			  multiple="multiple">
			  <option value="immortality" <?php if(array_search('immortality',$values['super'])!==false) print('selected="selected"');?>>Immortality</option>
			  <option value="walkthroughwalls" <?php if(array_search('walkthroughwalls',$values['super'])!==false) print('selected="selected"');?>>Walk through walls</option>
			  <option value="levitation" <?php if(array_search('levitation', $values['super'])!==false) print('selected="selected"');?>>levitation</option>
			</select>
